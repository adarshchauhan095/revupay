...
// import 'package:review_marketplace/screens/admin/user_management_screen.dart';
//
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            _buildFeatureCard('Manage Users', 'View and manage all users'),
            _buildFeatureCard('Review Management', 'Moderate reviews and reports'),
            _buildFeatureCard('Analytics Dashboard', 'Platform analytics and insights'),
            _buildFeatureCard('System Settings', 'Configure platform settings'),
          ],
        ),
      ),
    );
